...
<div class="container">
    ...
    <form method="POST" action="{{ route('materias_a/salvar') }}">
        @csrf
  ...
  <table style="margin-top:20px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td data-title="Selecionar">
                <input style="margin-left:5px;"type="checkbox" id="concluido" checked name="estagio" value="concluido">
                <label for="concluido">Concluído</label>
            </td>
        </tr>
        @else
        <tr>
            ...
            <td data-title="Horas Fixas">{{$curso->horas_estagio}}</td>
            <td data-title="Selecionar">
                <input style="margin-left:5px;"type="checkbox" id="concluido" name="estagio" value="concluido">
                <label for="concluido">Concluído</label>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td data-title="Selecionar">
                <input style="margin-left:5px;"type="checkbox" id="concluido" checked name="ativ" value="concluido">
                <label for="concluido">Concluído</label>
            </td>
        </tr>
        @else
         <tr>
            ...
            <td data-title="Horas Fixas">{{$curso->horas_ativ}}</td>
            <td data-title="Selecionar">
                <input style="margin-left:5px;"type="checkbox" id="concluido" name="ativ" value="concluido">
                <label for="concluido">Concluído</label>
            </td>
        </tr>
        @endif
